...
│  - role     : UserRole                           │
├──────────────────────────────────────────────────┤
│  + getUsername()    : String  // retorna email   │
│  + getPassword()    : String                     │
...
├──────────────────────────────────────────────────┤
│  @Query + countByStatus()        : List<Object[]>│
│  @Query + findDelayedProjects()  : List<Project> │
│  @Query + topClientsByProjects() : List<Object[]>│
│  @Query + totalRevenue()         : BigDecimal    │
└──────────────────────────────────────────────────┘
